...
const int panZero = 79;
const int tiltZero = 89;
...
void readSerial(){
  ...
  else if(motion == 'v'){trackLine(60, 0);}  //track a 'line' 10 inches from wall and start by going left
  ...
  else if(motion == 'k'){panLoc++;panServo.write(panLoc);Serial3.println(panLoc);}
  else if(motion == ';'){panLoc--;panServo.write(panLoc);Serial3.println(panLoc);}
  else if(motion == 'l'){tiltLoc++;tiltServo.write(tiltLoc);Serial3.println(tiltLoc);}
  else if(motion == 'o'){tiltLoc--;tiltServo.write(tiltLoc);Serial3.println(tiltLoc);}
