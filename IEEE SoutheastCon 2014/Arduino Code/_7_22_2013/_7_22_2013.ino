...
//line sensors-analog
//left to right
const int leftCenterSensor1 = 3;
const int leftNearSensor1 = 4;
const int leftFarSensor1 = 5;
const int rightCenterSensor1 = 2;
const int rightNearSensor1 = 1;
const int rightFarSensor1 = 0;
//front to back
const int leftCenterSensor2 = 9;
const int leftNearSensor2 = 10;
const int leftFarSensor2 = 11;
const int rightCenterSensor2 = 8;
const int rightNearSensor2 = 7;
const int rightFarSensor2 = 6;
      /*
