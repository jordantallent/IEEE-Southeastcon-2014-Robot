...
void loop(){
  ...
  else if (motion == 'S'){squareUp();}
  else if (motion == 'A'){aim();}
  else if (motion == '1'){lineTrack = lineDist1;findSpot;}
  else if (motion == '2'){lineTrack = lineDist2;findSpot;}
  else if (motion == '3'){lineTrack = lineDist3;findSpot;}
  else if (motion == '!'){lineTrack = lineDist1;onLine;}
  else if (motion == '@'){lineTrack = lineDist2;onLine;}
  else if (motion == '#'){lineTrack = lineDist3;onLine;}
  quickStop();
}
