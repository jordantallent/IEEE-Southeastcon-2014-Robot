...
const int frontPing = 3;  //analog 3
const int leftPing = 4;  //analog 4
const int rightPing = 5;  //analog 5
const int backPing = 6;  //analog 6
...
void loop(){
  while (!Serial.available() && digitalRead(startButton) == LOW){
    ;
  }
